...
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /usr/include/python3.9/pyport.h:508:9
...
pub const _Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `noinline`"); // /usr/include/python3.9/pyport.h:569:11
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`"); // /usr/include/python3.9/exports.h:20:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`"); // /usr/include/python3.9/exports.h:21:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`"); // /usr/include/python3.9/exports.h:22:17
...
pub const PyMODINIT_FUNC = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/python3.9/pyport.h:707:24
pub const Py_GCC_ATTRIBUTE = @compileError("unable to translate C expr: unexpected token '__attribute__'"); // /usr/include/python3.9/pyport.h:755:9
pub const Py_ALIGNED = @compileError("unable to translate macro: undefined identifier `aligned`"); // /usr/include/python3.9/pyport.h:762:9
pub const Py_ULL = @compileError("unable to translate macro: undefined identifier `U`"); // /usr/include/python3.9/pyport.h:779:9
pub const _Py_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__noreturn__`"); // /usr/include/python3.9/pyport.h:859:11
...
pub const Py_ARRAY_LENGTH = @compileError("unable to translate C expr: unexpected token '('"); // /usr/include/python3.9/pymacro.h:59:9
...
pub const _Py_IntegralTypeMax = @compileError("unable to translate C expr: expected ')' instead got 'A number'"); // /usr/include/python3.9/pymath.h:221:9
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/fnn45/zig12/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/fnn45/zig12/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /home/fnn45/zig12/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/fnn45/zig12/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/fnn45/zig12/lib/include/stdarg.h:46:9
...
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/python3.9/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/python3.9/pyfpe.h:12:9
