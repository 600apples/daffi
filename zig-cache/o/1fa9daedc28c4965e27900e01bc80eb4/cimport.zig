...
pub const PyInterpreterState = struct__is; // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pystate.h:127:22: warning: struct demoted to opaque type - has bitfield
...
pub const _Py_HashSecret_t = extern union {
    uc: [24]u8,
    fnv: struct_unnamed_10,
    siphash: struct_unnamed_11,
    djbx33a: struct_unnamed_12,
    expat: struct_unnamed_13,
};
...
} // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:110:22: warning: struct demoted to opaque type - has bitfield
const struct_unnamed_15 = opaque {};
pub const PyASCIIObject = extern struct {
    ob_base: PyObject,
    length: Py_ssize_t,
    hash: Py_hash_t,
    state: struct_unnamed_15,
};
...
pub const __COLD = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:102:11
...
pub const __warnattr = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:216:10
...
pub const __REDIRECT = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:256:10
pub const __REDIRECT_NTH = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:263:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:265:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:269:10
pub const __attribute_malloc__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:298:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:309:10
pub const __attribute_alloc_align__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:315:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:325:10
pub const __attribute_const__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:332:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:338:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:347:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:348:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:356:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:366:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:379:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:389:10
pub const __attribute_nonnull__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:401:11
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:414:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:423:10
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:441:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:450:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:468:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:469:11
pub const __restrict_arr = @compileError("unable to translate macro: undefined identifier `__restrict`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:512:10
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:561:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:638:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:639:10
...
pub const __fortified_attr_access = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:699:11
pub const __attr_access = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:700:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:701:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:711:10
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/x86_64-linux-gnu/sys/cdefs.h:718:10
...
pub const Py_LOCAL = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:183:11
pub const Py_LOCAL_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:184:11
...
pub const __counted_by = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /usr/include/linux/stddef.h:55:9
pub const __aligned_u64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/linux/types.h:50:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/linux/types.h:51:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /usr/include/linux/types.h:52:9
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:317:9
pub const _Py_COMP_DIAG_PUSH = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:335:9
pub const _Py_COMP_DIAG_IGNORE_DEPR_DECLS = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:336:9
pub const _Py_COMP_DIAG_POP = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:338:9
pub const Py_ALWAYS_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:401:11
pub const Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:417:11
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/exports.h:26:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/exports.h:27:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/exports.h:28:17
pub const PyAPI_DATA = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:546:16
pub const PyMODINIT_FUNC = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:552:24
pub const Py_GCC_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:600:9
pub const Py_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:607:9
pub const Py_ULL = @compileError("unable to translate macro: undefined identifier `U`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:624:9
pub const _Py_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:710:11
pub const _Py_TYPEOF = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pyport.h:735:11
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:35:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token '('"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:44:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')' instead got '['"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:61:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:64:9
pub const Py_ARRAY_LENGTH = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:81:9
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:92:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token '='"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:93:9
pub const Py_UNUSED = @compileError("unable to translate macro: undefined identifier `_unused_`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymacro.h:120:11
pub const PyMem_New = @compileError("unable to translate C expr: unexpected token ')'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymem.h:67:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got '='"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/pymem.h:77:9
pub const PyObject_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:79:9
pub const PyObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:138:9
pub const PyVarObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:146:9
pub const PyObject_VAR_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:158:9
pub const _PyObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:194:9
pub const _PyVarObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:202:9
pub const Py_CLEAR = @compileError("unable to translate macro: undefined identifier `_tmp_op_ptr`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:761:9
pub const Py_RETURN_NONE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:850:9
pub const Py_RETURN_NOTIMPLEMENTED = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:860:9
pub const Py_RETURN_RICHCOMPARE = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:884:9
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:53:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:54:9
pub const _Py_IDENTIFIER = @compileError("unable to translate macro: undefined identifier `PyId_`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:55:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_tmp_dst_ptr`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:349:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_tmp_dst_ptr`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:371:9
pub const _PyObject_ASSERT_WITH_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:431:9
pub const _PyObject_ASSERT_FAILED_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:436:9
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:521:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:533:9
pub const Py_TRASHCAN_SAFE_BEGIN = @compileError("unable to translate macro: undefined identifier `cond`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:549:9
pub const Py_TRASHCAN_SAFE_END = @compileError("unable to translate C expr: unexpected token ';'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/object.h:553:9
pub const _PyType_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/object.h:980:9
pub const PyObject_New = @compileError("unable to translate C expr: unexpected token ')'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:134:9
pub const PyObject_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:140:9
pub const PyObject_GC_Resize = @compileError("unable to translate C expr: unexpected token ')'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:183:9
pub const PyObject_GC_New = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:203:9
pub const PyObject_GC_NewVar = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:205:9
pub const Py_VISIT = @compileError("unable to translate macro: undefined identifier `vret`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/objimpl.h:216:9
pub const _PyByteArray_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/bytearrayobject.h:17:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/fnn45/zig11/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/fnn45/zig11/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/fnn45/zig11/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/fnn45/zig11/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/fnn45/zig11/lib/include/stdarg.h:46:9
pub const _PyBytes_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/bytesobject.h:32:9
...
pub const _PyASCIIObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:177:9
pub const _PyCompactUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:180:9
pub const _PyUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:183:9
pub const PyUnicode_1BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:276:9
pub const PyUnicode_2BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:277:9
pub const PyUnicode_4BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/unicodeobject.h:278:9
pub const PyException_HEAD = @compileError("unable to translate macro: undefined identifier `dict`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pyerrors.h:8:9
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/boolobject.h:33:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/boolobject.h:34:9
pub const Py_RETURN_NAN = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/floatobject.h:19:9
pub const Py_RETURN_INF = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/floatobject.h:21:9
pub const _PyFloat_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/floatobject.h:10:9
pub const _PyMemoryView_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/memoryobject.h:40:9
pub const _PyTuple_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/tupleobject.h:17:9
pub const _PyList_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/listobject.h:28:9
pub const PY_FOREACH_DICT_EVENT = @compileError("unable to translate macro: undefined identifier `ADDED`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/dictobject.h:93:9
pub const PY_DEF_EVENT = @compileError("unable to translate macro: undefined identifier `PyDict_EVENT_`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/dictobject.h:102:13
pub const _PySet_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/setobject.h:61:9
pub const _PyCFunction_CAST = @compileError("unable to translate C expr: unexpected token ')'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/methodobject.h:45:9
pub const _PyCFunctionObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/methodobject.h:16:9
pub const _PyCMethodObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/methodobject.h:28:9
pub const PyModuleDef_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/moduleobject.h:65:9
pub const _Py_COMMON_FIELDS = @compileError("unable to translate macro: undefined identifier `globals`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/funcobject.h:11:9
pub const _PyFunction_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/funcobject.h:90:9
pub const PY_FOREACH_FUNC_EVENT = @compileError("unable to translate macro: undefined identifier `CREATE`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/funcobject.h:137:9
pub const _PyMethod_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/classobject.h:29:9
pub const _PyInstanceMethod_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/classobject.h:56:9
pub const _PyCode_DEF = @compileError("unable to translate macro: undefined identifier `co_consts`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/code.h:109:9
pub const PY_FOREACH_CODE_EVENT = @compileError("unable to translate macro: undefined identifier `CREATE`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/code.h:275:9
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_weakreflist`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/genobject.h:14:9
pub const PyDescr_COMMON = @compileError("unable to translate macro: undefined identifier `d_common`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/descrobject.h:33:9
...
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pythread.h:42:9
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/modsupport.h:61:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/modsupport.h:62:9
pub const _PyInterpreterConfig_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pylifecycle.h:83:9
pub const _PyInterpreterConfig_LEGACY_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pylifecycle.h:94:9
pub const Py_BEGIN_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/ceval.h:142:9
pub const Py_BLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/ceval.h:145:9
pub const Py_UNBLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/ceval.h:146:9
pub const Py_END_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/ceval.h:147:9
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/linuxbrew/.linuxbrew/opt/python@3.12/include/python3.12/cpython/pyfpe.h:12:9
...
pub const C_RECURSION_LIMIT = @as(c_int, 10000);
...
pub const PyLong_AsPid = _PyLong_AsInt;
