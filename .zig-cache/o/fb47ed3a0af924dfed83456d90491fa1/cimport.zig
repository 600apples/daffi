...
pub const struct__typeobject = extern struct {
    ...
    tp_methods: [*c]struct_PyMethodDef = @import("std").mem.zeroes([*c]struct_PyMethodDef),
    tp_members: ?*struct_PyMemberDef = @import("std").mem.zeroes(?*struct_PyMemberDef),
    tp_getset: [*c]struct_PyGetSetDef = @import("std").mem.zeroes([*c]struct_PyGetSetDef),
    tp_base: [*c]struct__typeobject = @import("std").mem.zeroes([*c]struct__typeobject),
...
pub const struct__Py_Identifier = extern struct {
    next: [*c]struct__Py_Identifier = @import("std").mem.zeroes([*c]struct__Py_Identifier),
...
pub const struct__dictkeysobject_10 = opaque {};
pub const struct__heaptypeobject = extern struct {
    ...
    ht_cached_keys: ?*struct__dictkeysobject_10 = @import("std").mem.zeroes(?*struct__dictkeysobject_10),
...
pub const struct__err_stackitem = extern struct {
    exc_type: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    exc_value: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    exc_traceback: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
...
pub const struct__ts = extern struct {
    prev: [*c]struct__ts = @import("std").mem.zeroes([*c]struct__ts),
    next: [*c]struct__ts = @import("std").mem.zeroes([*c]struct__ts),
    interp: ?*PyInterpreterState = @import("std").mem.zeroes(?*PyInterpreterState),
    frame: ?*PyFrameObject = @import("std").mem.zeroes(?*PyFrameObject),
    recursion_depth: c_int = @import("std").mem.zeroes(c_int),
    overflowed: u8 = @import("std").mem.zeroes(u8),
    recursion_critical: u8 = @import("std").mem.zeroes(u8),
    stackcheck_counter: c_int = @import("std").mem.zeroes(c_int),
    tracing: c_int = @import("std").mem.zeroes(c_int),
    use_tracing: c_int = @import("std").mem.zeroes(c_int),
...
pub fn _PyObject_INIT(arg_op: [*c]PyObject, arg_typeobj: [*c]PyTypeObject) callconv(.C) [*c]PyObject {
    ...
    if ((PyType_GetFlags(typeobj) & (@as(c_ulong, 1) << @intCast(9))) != 0) {
        _Py_INCREF(@as([*c]PyObject, @ptrCast(@alignCast(typeobj))));
    }
    _Py_NewReference(op);
    return op;
}
pub fn _PyObject_INIT_VAR(arg_op: [*c]PyVarObject, arg_typeobj: [*c]PyTypeObject, arg_size: Py_ssize_t) callconv(.C) [*c]PyVarObject {
    ...
    _ = _PyObject_INIT(@as([*c]PyObject, @ptrCast(@alignCast(op))), typeobj);
    return op;
}
...
pub extern fn PyBytes_FromFormatV([*c]const u8, [*c]struct___va_list_tag_1) [*c]PyObject;
...
pub extern fn PyUnicode_FromFormatV(format: [*c]const u8, vargs: [*c]struct___va_list_tag_1) [*c]PyObject;
...
pub const PyASCIIObject = extern struct {
    ...
    state: struct_unnamed_16 = @import("std").mem.zeroes(struct_unnamed_16),
...
pub const PyDictKeysObject = struct__dictkeysobject_10;
pub const PyDictObject = extern struct {
    ...
    ma_values: [*c][*c]PyObject = @import("std").mem.zeroes([*c][*c]PyObject),
};
...
pub const struct_PyModuleDef = extern struct {
    ...
    m_slots: [*c]struct_PyModuleDef_Slot = @import("std").mem.zeroes([*c]struct_PyModuleDef_Slot),
...
pub const struct_PyCodeObject = extern struct {
    ...
    co_code: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_consts: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_names: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_varnames: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_freevars: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_cellvars: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_cell2arg: [*c]Py_ssize_t = @import("std").mem.zeroes([*c]Py_ssize_t),
    co_filename: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_name: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_lnotab: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_zombieframe: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    co_weakreflist: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    co_extra: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    co_opcache_map: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    co_opcache: ?*_PyOpcache = @import("std").mem.zeroes(?*_PyOpcache),
    co_opcache_flag: c_int = @import("std").mem.zeroes(c_int),
    co_opcache_size: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct__addr_pair = extern struct {
    ap_lower: c_int = @import("std").mem.zeroes(c_int),
    ap_upper: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct__traceback = extern struct {
    ob_base: PyObject = @import("std").mem.zeroes(PyObject),
    tb_next: [*c]struct__traceback = @import("std").mem.zeroes([*c]struct__traceback),
...
pub const PyStatus = extern struct {
    _type: enum_unnamed_18 = @import("std").mem.zeroes(enum_unnamed_18),
...
pub const PyConfig = extern struct {
    ...
    _use_peg_parser: c_int = @import("std").mem.zeroes(c_int),
    ...
    _orig_argv: PyWideStringList = @import("std").mem.zeroes(PyWideStringList),
};
...
pub const struct__xid = extern struct {
    ...
    new_object: ?*const fn ([*c]struct__xid) callconv(.C) [*c]PyObject = @import("std").mem.zeroes(?*const fn ([*c]struct__xid) callconv(.C) [*c]PyObject),
...
pub const PyGenObject = extern struct {
    ob_base: PyObject = @import("std").mem.zeroes(PyObject),
    gi_frame: ?*PyFrameObject = @import("std").mem.zeroes(?*PyFrameObject),
    gi_running: u8 = @import("std").mem.zeroes(u8),
    gi_code: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
...
pub const PyCoroObject = extern struct {
    ob_base: PyObject = @import("std").mem.zeroes(PyObject),
    cr_frame: ?*PyFrameObject = @import("std").mem.zeroes(?*PyFrameObject),
    cr_running: u8 = @import("std").mem.zeroes(u8),
    cr_code: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    ...
    cr_origin: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
};
...
pub const PyAsyncGenObject = extern struct {
    ob_base: PyObject = @import("std").mem.zeroes(PyObject),
    ag_frame: ?*PyFrameObject = @import("std").mem.zeroes(?*PyFrameObject),
    ag_running: u8 = @import("std").mem.zeroes(u8),
    ag_code: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    ...
    ag_finalizer: [*c]PyObject = @import("std").mem.zeroes([*c]PyObject),
    ag_hooks_inited: c_int = @import("std").mem.zeroes(c_int),
    ag_closed: c_int = @import("std").mem.zeroes(c_int),
    ag_running_async: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const PyMemberDescrObject = extern struct {
    d_common: PyDescrObject = @import("std").mem.zeroes(PyDescrObject),
    d_member: ?*struct_PyMemberDef = @import("std").mem.zeroes(?*struct_PyMemberDef),
};
...
pub const struct_PyStructSequence_Desc = extern struct {
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    doc: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    fields: [*c]struct_PyStructSequence_Field = @import("std").mem.zeroes([*c]struct_PyStructSequence_Field),
...
pub extern fn PyErr_FormatV(exception: [*c]PyObject, format: [*c]const u8, vargs: [*c]struct___va_list_tag_1) [*c]PyObject;
...
pub extern fn PyOS_vsnprintf(str: [*c]u8, size: usize, format: [*c]const u8, va: [*c]struct___va_list_tag_1) c_int;
...
pub extern fn _PyArg_VaParse_SizeT([*c]PyObject, [*c]const u8, [*c]struct___va_list_tag_1) c_int;
pub extern fn _PyArg_VaParseTupleAndKeywords_SizeT([*c]PyObject, [*c]PyObject, [*c]const u8, [*c][*c]u8, [*c]struct___va_list_tag_1) c_int;
...
pub extern fn _Py_VaBuildValue_SizeT([*c]const u8, [*c]struct___va_list_tag_1) [*c]PyObject;
pub extern fn _Py_VaBuildStack_SizeT(small_stack: [*c][*c]PyObject, small_stack_len: Py_ssize_t, format: [*c]const u8, va: [*c]struct___va_list_tag_1, p_nargs: [*c]Py_ssize_t) [*c][*c]PyObject;
...
pub extern fn _PyArg_VaParseTupleAndKeywordsFast_SizeT([*c]PyObject, [*c]PyObject, [*c]struct__PyArg_Parser, [*c]struct___va_list_tag_1) c_int;
...
pub const _PyASTOptimizeState = extern struct {
    optimize: c_int = @import("std").mem.zeroes(c_int),
    ff_features: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const SNANF = @compileError("unable to translate macro: undefined identifier `__builtin_nansf`");
// /usr/include/math.h:110:11
pub const SNAN = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /usr/include/math.h:111:11
pub const SNANL = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`");
// /usr/include/math.h:112:11
...
pub const __MATHCALL_NARROW_ARGS_1 = @compileError("unable to translate macro: undefined identifier `__x`");
// /usr/include/math.h:550:9
pub const __MATHCALL_NARROW_ARGS_2 = @compileError("unable to translate macro: undefined identifier `__x`");
// /usr/include/math.h:551:9
pub const __MATHCALL_NARROW_ARGS_3 = @compileError("unable to translate macro: undefined identifier `__x`");
// /usr/include/math.h:552:9
pub const __MATHCALL_NARROW_NORMAL = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`");
// /usr/include/math.h:553:9
pub const __MATHCALL_NARROW_REDIR = @compileError("unable to translate macro: undefined identifier `__MATHCALL_NARROW_ARGS_`");
...
pub const __MATHCALL_NAME = @compileError("unable to translate macro: undefined identifier `f`");
// /usr/include/math.h:565:10
...
pub const __iscanonicalf = @compileError("unable to translate C expr: unexpected token '__typeof'");
// /usr/include/x86_64-linux-gnu/bits/iscanonical.h:25:9
pub const __iscanonical = @compileError("unable to translate C expr: unexpected token '__typeof'");
// /usr/include/x86_64-linux-gnu/bits/iscanonical.h:26:9
...
pub const iszero = @compileError("unable to translate C expr: unexpected token '__typeof'");
// /usr/include/math.h:1095:12
...
pub const _Py_SET_EDOM_FOR_NAN = @compileError("unable to translate C expr: unexpected token ';'");
// /usr/include/python3.9/pyport.h:330:9
pub const Py_SET_ERRNO_ON_MATH_ERROR = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/python3.9/pyport.h:332:9
pub inline fn Py_SET_ERANGE_IF_OVERFLOW(X: anytype) @TypeOf(Py_SET_ERRNO_ON_MATH_ERROR(X)) {
    _ = &X;
    return Py_SET_ERRNO_ON_MATH_ERROR(X);
}
pub const Py_ADJUST_ERANGE1 = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/python3.9/pyport.h:360:9
pub const Py_ADJUST_ERANGE2 = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/python3.9/pyport.h:370:9
pub const HAVE_PY_SET_53BIT_PRECISION = @as(c_int, 1);
pub const _Py_SET_53BIT_PRECISION_HEADER = @compileError("unable to translate macro: undefined identifier `old_387controlword`");
// /usr/include/python3.9/pyport.h:408:9
pub const _Py_SET_53BIT_PRECISION_START = @compileError("unable to translate macro: undefined identifier `old_387controlword`");
// /usr/include/python3.9/pyport.h:410:9
pub const _Py_SET_53BIT_PRECISION_END = @compileError("unable to translate macro: undefined identifier `new_387controlword`");
// /usr/include/python3.9/pyport.h:417:9
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /usr/include/python3.9/pyport.h:508:9
pub const _Py_COMP_DIAG_PUSH = @compileError("unable to translate macro: undefined identifier `_Pragma`");
// /usr/include/python3.9/pyport.h:517:9
pub const _Py_COMP_DIAG_IGNORE_DEPR_DECLS = @compileError("unable to translate macro: undefined identifier `_Pragma`");
// /usr/include/python3.9/pyport.h:518:9
pub const _Py_COMP_DIAG_POP = @compileError("unable to translate macro: undefined identifier `_Pragma`");
// /usr/include/python3.9/pyport.h:520:9
pub const _Py_HOT_FUNCTION = "";
pub const _Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `noinline`");
// /usr/include/python3.9/pyport.h:569:11
pub const Py_EXPORTS_H = "";
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/python3.9/exports.h:20:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/python3.9/exports.h:21:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/python3.9/exports.h:22:17
...
// /usr/include/python3.9/pyport.h:779:9
...
// /usr/include/python3.9/pyport.h:859:11
...
// /usr/include/python3.9/pymacro.h:13:9
...
// /usr/include/python3.9/pymacro.h:98:11
...
pub const Py_NAN = Py_HUGE_VAL * @as(f64, 0);
...
pub const _Py_IntegralTypeMax = @compileError("unable to translate C expr: expected ')' instead got 'A number'");
// /usr/include/python3.9/pymath.h:221:9
...
// /usr/include/python3.9/object.h:113:9
...
pub const Py_CLEAR = @compileError("unable to translate macro: undefined identifier `_py_tmp`");
// /usr/include/python3.9/object.h:475:9
...
// /usr/include/python3.9/object.h:517:9: warning: macro 'Py_None' contains a runtime value, translated to function
...
// /usr/include/python3.9/object.h:520:9

// /usr/include/python3.9/object.h:527:9: warning: macro 'Py_NotImplemented' contains a runtime value, translated to function
...
// /usr/include/python3.9/object.h:530:9
...
pub const PyHeapType_GET_MEMBERS = @compileError("unable to translate C expr: unexpected token ')'");
// /usr/include/python3.9/cpython/object.h:297:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`");
// /usr/include/python3.9/cpython/object.h:366:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_py_tmp`");
// /usr/include/python3.9/cpython/object.h:373:9
...
// /usr/include/python3.9/cpython/object.h:422:9
...
// /usr/include/python3.9/cpython/object.h:427:9
pub const PyTrash_UNWIND_LEVEL = @as(c_int, 50);
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`");
// /usr/include/python3.9/cpython/object.h:525:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`");
// /usr/include/python3.9/cpython/object.h:537:9
...
// /usr/include/python3.9/pymem.h:78:9
pub const PyMem_NEW = @compileError("unable to translate C expr: unexpected token ')'");
// /usr/include/python3.9/pymem.h:81:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got '='");
// /usr/include/python3.9/pymem.h:91:9
pub const PyMem_RESIZE = @compileError("unable to translate C expr: expected ')' instead got '='");
// /usr/include/python3.9/pymem.h:94:9
...
// /usr/include/python3.9/objimpl.h:125:9
...
// /usr/include/python3.9/objimpl.h:131:9
...
// /home/fnn45/zig/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /home/fnn45/zig/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /home/fnn45/zig/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/fnn45/zig/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/fnn45/zig/lib/include/__stdarg_va_copy.h:11:9
...
pub const PyUnicode_AS_DATA = @compileError("unable to translate C expr: unexpected token 'const'");
// /usr/include/python3.9/cpython/unicodeobject.h:282:9
...
pub const PyUnicode_WRITE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/python3.9/cpython/unicodeobject.h:363:9
pub const PyUnicode_READ = @compileError("unable to translate C expr: unexpected token 'const'");
// /usr/include/python3.9/cpython/unicodeobject.h:383:9
pub const PyUnicode_READ_CHAR = @compileError("unable to translate C expr: unexpected token 'const'");
// /usr/include/python3.9/cpython/unicodeobject.h:397:9
...
pub inline fn PyUnicode_MAX_CHAR_VALUE(op: anytype) @TypeOf(if (PyUnicode_IS_ASCII(op)) @as(c_int, 0x7f) else if (PyUnicode_KIND(op) == PyUnicode_1BYTE_KIND) @as(c_uint, 0xff) else if (PyUnicode_KIND(op) == PyUnicode_2BYTE_KIND) @as(c_uint, 0xffff) else @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10ffff, .hex)) {
    _ = &op;
    return blk_1: {
        _ = assert(PyUnicode_IS_READY(op));
        break :blk_1 if (PyUnicode_IS_ASCII(op)) @as(c_int, 0x7f) else if (PyUnicode_KIND(op) == PyUnicode_1BYTE_KIND) @as(c_uint, 0xff) else if (PyUnicode_KIND(op) == PyUnicode_2BYTE_KIND) @as(c_uint, 0xffff) else @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0x10ffff, .hex);
    };
}
...
// /usr/include/python3.9/boolobject.h:21:9: warning: macro 'Py_False' contains a runtime value, translated to function
pub inline fn Py_False() @TypeOf(@import("std").zig.c_translation.cast([*c]PyObject, &_Py_FalseStruct)) {
    return @import("std").zig.c_translation.cast([*c]PyObject, &_Py_FalseStruct);
}
// /usr/include/python3.9/boolobject.h:22:9: warning: macro 'Py_True' contains a runtime value, translated to function
pub inline fn Py_True() @TypeOf(@import("std").zig.c_translation.cast([*c]PyObject, &_Py_TrueStruct)) {
    return @import("std").zig.c_translation.cast([*c]PyObject, &_Py_TrueStruct);
}
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token 'return'");
// /usr/include/python3.9/boolobject.h:25:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token 'return'");
// /usr/include/python3.9/boolobject.h:26:9
...
pub const PyTuple_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='");
// /usr/include/python3.9/cpython/tupleobject.h:30:9
...
pub const PyList_SET_ITEM = @compileError("unable to translate C expr: expected ')' instead got '='");
// /usr/include/python3.9/cpython/listobject.h:37:9
...
// /usr/include/python3.9/moduleobject.h:51:9
...
// /usr/include/python3.9/sliceobject.h:11:9: warning: macro 'Py_Ellipsis' contains a runtime value, translated to function
...
pub const PyCell_SET = @compileError("unable to translate C expr: expected ')' instead got '='");
// /usr/include/python3.9/cellobject.h:23:9
...
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_running`");
// /usr/include/python3.9/genobject.h:15:9
...
// /usr/include/python3.9/descrobject.h:48:9
...
// /usr/include/python3.9/cpython/pyerrors.h:12:9
...
// /usr/include/python3.9/pythread.h:151:9
...
pub const Py_ALLOW_RECURSION = @compileError("unable to translate macro: undefined identifier `_old`");
// /usr/include/python3.9/ceval.h:70:9
pub const Py_END_ALLOW_RECURSION = @compileError("unable to translate macro: undefined identifier `_old`");
// /usr/include/python3.9/ceval.h:74:9
pub const Py_BEGIN_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`");
// /usr/include/python3.9/ceval.h:140:9
pub const Py_BLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`");
// /usr/include/python3.9/ceval.h:143:9
pub const Py_UNBLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`");
// /usr/include/python3.9/ceval.h:144:9
pub const Py_END_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`");
// /usr/include/python3.9/ceval.h:145:9
